...
export interface ActionAuditLog {
  ...
  profileId: string;
  timestamp: string; // ISO String
  actionType: "MEDICATION_TAKEN" | "MEDICATION_SKIPPED" | "MEDICATION_ADDED" | "MEDICATION_EDITED" | "MEDICATION_PAUSED" | "EMAIL_SENT" | "PROFILE_UPDATED" | "LOG_EXPORTED" | "UI_INTERACTION" | "WATER_LOGGED" | "WATER_TARGET_UPDATED" | "WATER_LOG_DELETED" | "GLUCOSE_LOGGED" | "GLUCOSE_LOG_DELETED" | "GLUCOSE_TARGET_UPDATED" | "BP_LOGGED" | "BP_LOG_DELETED";
  description: string;
